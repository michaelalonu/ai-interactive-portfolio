...
- Backend: deploy the FastAPI service to Render.
- Frontend: deploy the Vite application to Vercel.
- Set production environment variables in both platforms.
- Update `VITE_API_URL`, `BASE_URL`, and `CORS_ORIGINS` to use the deployed URLs.
